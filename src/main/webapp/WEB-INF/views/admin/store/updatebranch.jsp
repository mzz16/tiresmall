...
<tr>
<td>구분</td>
<td> <input type='radio' name='b_sortation' value="${branch1.b_sortation }" />직영점(당일장착점)
<input type='radio' name='b_sortation' value="${branch1.b_sortation }" /> 제휴장착점
</td>
</tr>
...
<tr>
<td>연락처</td>
<td>담당자명 <input name = "b_manager" value="${branch1.b_manager }"> 전화번호 <input name = "b_managernumber" value="${branch1.b_managernumber }"></td>
</tr>

<tr>
<td>사업자정보</td>
<td>업체명<input name = "b_branchname" value="${branch1.b_branchname }">사업자번호<input name = "b_branchnumber" value="${branch1.b_branchnumber }"><br>대표자명<input name = "b_cr" value="${branch1.b_cr }">사업자이메일<input name = "b_email" value="${branch1.b_email }"></td>
</tr>
