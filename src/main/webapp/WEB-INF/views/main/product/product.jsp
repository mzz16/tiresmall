		...
		<div id="product_container">
			...
			<%-- <c:forEach items="" var=""> --%>
				<div class="product_item">
					...
					<div class="product_item_text">tire.t_text</div>
					<div class="product_item_size">tire.t_size</div>
					<div class="product_item_price">tire.t_price</div>
					<a href="detail.test"><div class="product_item_detail"><i class="fa-solid fa-magnifying-glass"></i>상세보기</div></a>
				</div>
			<%-- </c:forEach> --%>
			<div class="product_item">
				<div class="product_item_img">
