  ...
  <body>
    ...
    <div class="detail_nav">
      <ul class="detail_nav_ul">
        <li class="detail_nav_li">상품정보</li>
        <li class="detail_nav_li">구매 전 확인사항</li>
        <li class="detail_nav_li">타이어 장착 안내</li>
        <li class="detail_nav_li">배송 / 반품 / 교환 / AS 안내</li>
      </ul>
    </div>
    <div class="detail_container">
      <div class="detail_include">
        ...
        <ul>
          <li style="display: none">
            ...
            <p>
              타이어 선택 후 원하시는 장착일을 선택하시고 지정한 날짜에 방문 후
              장착하시면 됩니다.
            </p>
            ...
            <p>
              타이어를 예약 후 타이어쇼핑몰 직영점 으로 방문하시어 장착 완료 후
              현장에서 결제 해주시면 됩니다.
            </p>
            <p>
        ...
        <ul>
          <li style="display: none">
            ...
            <p>
              - 배송기간 : 오후 4시 이전 주문시 당일 발송 / 평균 배송기간 2~3일
              소요 ( 해당제품 재고 일시품절시 배송기간 추가 )
            </p>
            <h1>2. 반품 및 교환 안내</h1>
            ...
            <p>
              - 소비자의 책임으로 인한 상품의 훼손 및 멸실이 발생한 경우 불가능
            </p>
