...
<body>
	<form action="board.qna.update.do" method="post">
		<div class="board_qna_cu_rowAndValue">
			<div>제목<span class="board_qna_cu_important">*</span></div>
			<div><input required name="q_title" type="text" value="${qna.q_title}"></div>
			<div>내용<span class="board_qna_cu_important">*</span></div>
			<div>
				<div>
					<textarea required name="q_txt" maxlength="2000">${qna.q_txt}</textarea>
		...
		<div class="board_qna_cu_buttons">
				<button class="board_qna_buttonRed" name="q_no" value="${qna.q_no}">수정하기</button>
